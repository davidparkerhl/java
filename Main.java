...
// 名字 种类 颜色 年龄 性别 服务 状态 主人 是否会员
        ...
        JTextField nameField = new JTextField("",WIDTH);
        panel.add(nameField);

        panel.add(new JLabel("种类:"));
        JTextField typeField = new JTextField("",WIDTH);
        panel.add(typeField);

        panel.add(new JLabel("颜色:"));
        JTextField colourField = new JTextField("",WIDTH);
        panel.add(colourField);

        panel.add(new JLabel("年龄:"));
        JTextField ageField = new JTextField("",WIDTH);
        panel.add(ageField);

        panel.add(new JLabel("性别:"));
        JTextField genderField = new JTextField("",WIDTH);
        panel.add(genderField);

        panel.add(new JLabel("服务:"));
        JTextField serviceField = new JTextField("",WIDTH);
        panel.add(serviceField);

        panel.add(new JLabel("状态:"));
        JTextField statusField = new JTextField("",WIDTH);
        panel.add(statusField);

        panel.add(new JLabel("主人:"));
        JTextField ownerField = new JTextField("",WIDTH);
        panel.add(ownerField);

        panel.add(new JLabel("是否会员:"));
        JTextField premiumField = new JTextField("",WIDTH);
        ...
        {//添加事件
            public void actionPerformed(ActionEvent e)
            {
                String[] rowValues = {nameField.getText(),typeField.getText(),colourField.getText(),ageField.getText(),genderField.getText(),serviceField.getText(),statusField.getText(),ownerField.getText(),premiumField.getText()};
